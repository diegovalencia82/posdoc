...
gfortran -c neighboring_searchv.f
gfortran -c kernel.f
...
ar ru mysph.a input.o time_integration.o single_step.o neighboring_search.o neighboring_searchv.o  kernel.o wijdwij.o density.o presioni.o momento.o sph_presion.o tasa_deformacion_epsilon.o viscous_force.o external_force.o
